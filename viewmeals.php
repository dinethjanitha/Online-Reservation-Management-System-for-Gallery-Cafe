...
if (isset($_POST['searchsubmit'])) {
    ...
    $query = "SELECT * FROM meals
        ...
        WHERE origin_name LIKE '%{$searchval}%' OR meal_name LIKE '%{$searchval}%'
             OR description LIKE '%{$searchval}%' OR catagory_name LIKE '%{$searchval}%' ";
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-center">
                                <h2>Food Items Of Our Restaurant</h2>
                                <span class="meal-header">Our Foods Items</span>
                            </div>
                        </div>
                    </div>
                    <form action="viewmeals.php" method="post">
                        <div class="row mt-3">
                        ...
                        <div class="d-flex search-bar flex-row  align-items-center mt-3 mb-3">
                            ...
                            <div class="flex-grow-1">
                                <input type="text" class="form-control col-10" name="searchval" placeholder="Search with Meal Name or Catagory Name or Origin Name or Description">
                            </div>
                            <div class="bt">
